...
const store = createStore(combineReducers({prenom, category, recette, ajoutCats, ajoutTitre, ajoutPrepa, photo, searchText, newRecette, ajoutIngredients, ajoutEtapes, token}))
